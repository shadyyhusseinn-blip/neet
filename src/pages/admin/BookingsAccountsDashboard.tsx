...
import { Calendar, Database, DollarSign, LogOut, ArrowLeft } from 'lucide-react';
...
const SECTIONS = [
  {
    id: 'management',
    title: 'إدارة الحجوزات والحسابات',
    description: 'التحكم الكامل في الحجوزات والحسابات',
    icon: Calendar,
  ...
  {
    id: 'bookings',
    title: 'سجل الحجوزات القديم',
    description: 'عرض سجل الحجوزات القديم',
    icon: Calendar,
  ...
  {
    id: 'accounts',
    title: 'الحسابات القديم',
    description: 'عرض الحسابات القديم',
    icon: DollarSign,
...
export default function BookingsAccountsDashboard() {
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">إدارة الحجوزات والحسابات المالية</p>
            </div>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}

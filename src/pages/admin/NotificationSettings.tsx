...
import { 
  ...
  Clock, DollarSign, Calendar, Save, TestTube, Info
} from 'lucide-react';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-white">إعدادات الرسائل والتنبيهات</h1>
            <p className="text-sm text-pink-300/70 mt-1">إدارة إشعارات SMS والتنبيهات التلقائية</p>
          </div>
        </div>
        <button
          onClick={saveConfig}
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/10 via-cyan-500/10 to-teal-500/10 p-6 backdrop-blur-xl shadow-xl shadow-blue-500/10">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-extrabold text-pink-300/90 mb-2">رقم الهاتف (مع رمز الدولة)</label>
                <input
                  type="tel"
              ...
              >
                ...
                <div className="flex items-start gap-2 p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  ...
                  <p className="text-xs text-pink-300/70">
                    سيتم إرسال تنبيه قبل الحجز بعدد الساعات المحددة
                  </p>
                </div>
              </motion.div>
            )}
            ...
            {config.paymentReminderEnabled && (
              ...
              >
                ...
                <div className="flex items-start gap-2 p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20">
                  ...
                  <p className="text-xs text-pink-300/70">
                    سيتم إرسال تنبيه للمبالغ المتبقية المتأخرة
                  </p>
                </div>
              </motion.div>
            )}

...
import { Code, Settings, Database, Activity, LogOut, ArrowLeft } from 'lucide-react';
...
const SECTIONS = [
  {
    id: 'management',
    title: 'إدارة أدوات المطور',
    description: 'التحكم الكامل في أدوات المطور',
    icon: Code,
    color: 'from-amber-500 to-orange-500',
    route: '/admin/developer-management'
  },
  {
    id: 'settings',
    title: 'الإعدادات القديم',
    description: 'عرض الإعدادات القديم',
    icon: Settings,
  ...
  {
    id: 'activity-log',
    title: 'سجل النشاط القديم',
    description: 'عرض سجل النشاط القديم',
    icon: Activity,
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">الإعدادات المتقدمة وأدوات التطوير</p>
            </div>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}

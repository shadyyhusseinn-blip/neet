...
export default function DevelopmentPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: 'إعدادات Firebase والتكوين',
      icon: Cloud,
    ...
    },
    {
      id: 'developer',
      title: 'المطور',
      description: 'أدوات المطور والتشخيص',
      icon: Code,
    ...
    },
    {
      id: 'activity-log',
      title: 'سجل الأنشطة',
      description: 'سجل جميع الأنشطة والعمليات',
      icon: History,
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1e293b] p-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400">إدارة النظام والإعدادات التقنية</p>
        </motion.div>

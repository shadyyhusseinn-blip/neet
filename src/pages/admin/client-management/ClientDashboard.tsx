...
import { Palette, Upload, Image, Settings, ArrowRight } from 'lucide-react';
...
const SECTIONS = [
  {
    id: 'appearance',
    title: 'المظهر العام',
    description: 'التحكم في الألوان والسمات',
    icon: Palette,
    color: 'from-purple-500 to-pink-500',
    route: '/admin/client-management/appearance'
  },
  {
    id: 'deliverables',
    title: 'تسليمات العملاء',
    description: 'إدارة تسليمات الصور',
    icon: Upload,
    color: 'from-blue-500 to-cyan-500',
    route: '/admin/client-management/deliverables'
  },
  {
    id: 'content',
    title: 'إدارة المحتوى',
    description: 'تعديل المحتوى العام',
    icon: Image,
    color: 'from-green-500 to-emerald-500',
    route: '/admin/client-management/content'
  }
];

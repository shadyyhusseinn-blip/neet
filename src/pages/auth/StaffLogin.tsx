...
export default function StaffLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After successful login, navigate to staff dashboard
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-6">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">تسجيل الدخول للوحة تحكم الموظفين</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-lg pl-12 pr-4 py-3 text-white focus:border-blue-500 transition-colors"
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl text-white font-semibold hover:from-blue-600 hover:to-cyan-600 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >

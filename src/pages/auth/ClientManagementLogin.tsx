...
export default function ClientManagementLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After successful login, navigate directly to client management dashboard (bypass selection)
      navigate('/admin/client-management/dashboard');
    } catch (err: any) {
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-6">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">تسجيل الدخول المباشر لإدارة المحتوى والعملاء</p>
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-lg pl-12 pr-4 py-3 text-white focus:border-green-500 transition-colors"
